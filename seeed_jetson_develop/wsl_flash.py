        ...
        script = "\n".join(
            [
                ...
                *copy_block,
                ...
                "  exit 43",
                "fi",
                'UNIFIED_FLASH_PREFIX=""',
                'if [ -d "$L4T_DIR/unified_flash/out/bsp_images/flash_workspace" ]; then',
                '  export UNIFIED_FLASH=1',
                '  UNIFIED_FLASH_PREFIX="UNIFIED_FLASH=1 "',
                '  echo "[WSL] NVIDIA unified flash package detected (Jetson Thor mode)."',
                'elif [ ! -d "$L4T_DIR/bootloader" ]; then',
                '  echo "[WSL] Extracted firmware is incomplete: missing bootloader and unified_flash images." >&2',
                "  exit 45",
                "fi",
                'export WSL=1',
                ...
                'cd "$L4T_DIR"',
                'echo "[WSL] Flash command: ${UNIFIED_FLASH_PREFIX}./tools/kernel_flash/l4t_initrd_flash.wsl.sh --flash-only --massflash 1 --network usb0 --showlogs"',
