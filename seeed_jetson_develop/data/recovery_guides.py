...
GUIDES = {
    ...
    "agx-orin-devkit": {
        ...
        "steps": [
            ...
            "按住 Force Recovery 按钮（载板上标记为 2 号按钮的中间按钮）并保持。",
            "若设备已开机，按下并松开 Reset 按钮（3 号按钮）；若未开机，连接电源适配器。",
        ...
        "steps_en": [
            ...
            "Press and hold the Force Recovery button (the middle button marked as button 2 on the carrier board).",
            "If the board is powered on, press and release the Reset button (button 3); if powered off, connect the power adapter.",
            "Release the Force Recovery button.",
            "Run lsusb on the host to confirm the device is in Recovery mode.",
        ],
        "usb_ids": AGX_IDS,
